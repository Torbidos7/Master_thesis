...
It sets a lower bound for the spatial sampling rate which must be twice smaller than the smallest detail of the image and this it is possible to avoid artifact due to incorrect sampling.
